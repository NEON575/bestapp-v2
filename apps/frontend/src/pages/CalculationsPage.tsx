...
function ModalShell({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-start justify-center overflow-y-auto bg-slate-950/70 px-4 py-6 backdrop-blur-xl sm:py-8">
      <div className="mt-0 flex max-h-[calc(100dvh-48px)] w-full max-w-7xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl sm:mt-auto sm:mb-auto">
        <div className="shrink-0 border-b border-slate-200 bg-white/90 px-6 py-5 backdrop-blur-xl">
