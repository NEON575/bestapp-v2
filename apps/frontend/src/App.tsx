...
import { CalculationBlockEditorPage } from './pages/CalculationBlockEditorPage';
  ...
  return (
    <Routes>
      <Route path="/" element={<DashboardLayout />}>
        ...
        <Route path="calculations/new" element={<CalculationBlockEditorPage />} />
        <Route path="calculations/:id" element={<CalculationBlockEditorPage />} />
        <Route path="calculations/:id/edit" element={<CalculationBlockEditorPage />} />
